		...
		try {
			...
			while (iterator.hasNext()) {
				...
				if (currentModelElement.eClass().getName().equals("Model")) {
					EPackage classAttribute = currentModelElement.eClass().getEPackage();
					//tring name = (String) currentModelElement.eGet(classAttribute);
					System.out.println(classAttribute);
					//currentModelElement.eSet(classAttribute, name + "transformation");
				}
			}
			javaModel.save(new FileOutputStream("sampleJava_Cut.xmi"), null);
